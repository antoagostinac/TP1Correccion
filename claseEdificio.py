...
#Este es un metodo set para la clase edificio se utiliza para estabalecer el valor de un atributo.
...
#Este es un metodo publico llamado mostrarInformacio para la clase edificio .
